...
router.post("/playlists/:playlistId/videos", authMiddleware, createVideo);

// Ruta para obtener todos los videos de una playlist
// GET /playlists/:playlistId/videos
router.get("/playlists/:playlistId/videos", authMiddleware, getVideos);

// Ruta para actualizar un video existente
// PATCH /videos/:videoId
router.patch("/videos/:videoId", authMiddleware, updateVideo);
...
// GET /videos/:videoId
router.get("/videos/:videoId", authMiddleware, getVideoById);
